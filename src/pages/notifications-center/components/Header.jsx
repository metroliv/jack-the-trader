    ...
    <header className="bg-surface border-b border-border h-16 flex items-center justify-between px-6 sticky top-0 z-10">
      <div className="flex items-center">
        ...
        <div className="relative">
          ...
          <input 
            type="text" placeholder="Search notifications..." className="bg-gray-50 border border-border text-text-primary text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-2.5"
          />
        </div>
      </div>
      
      <div className="flex items-center space-x-4">
        <Link to="/notifications-center" className="relative p-2 text-primary rounded-full bg-primary-light">
