        ...
        <div className="space-y-1">
          {navigationItems.map((item) => (
            ...
            >
              ...
              {item.name === "Notifications" && location.pathname !== "/notifications-center" && (
                <span className="ml-auto bg-danger text-white text-xs font-medium px-1.5 py-0.5 rounded-full">
                  3
                </span>
              )}
            </Link>
